...
const ServicesPage = () => {
  return (
    <Layout pageTitle="🧰 Services">
      ...
      <p>Off-page SEO is the practice of using other domains to boost your own site's search rankings. It's all about generating links to your content from other sites, also known as backlinks. Google sees backlinks as a sign of authority and expertise. The more backlinks a site has, the better it ranks. Off-page SEO is all about finding and acting on these link-building opportunities. </p>
